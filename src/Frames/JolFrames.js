...
export function JolFrame3(props) {
  return (<>
      <LikertFrame
        ...
        step={10}
        unit={'%'}
        title={'<p>3. Verifikationsaufgabe Typ 1:<br/> Du erhältst u.a. weitere 8 Textaufgaben und jeweils eine rechnerische Lösung. Deine Aufgabe besteht nun darin, mit “Ja” vs. “Nein” zu entscheiden, ob die rechnerische Lösung zur Aufgabe passt. Wenn du rätst, so ist die Zufallswahrscheinlichkeit 50% richtig zu antworten.</p> ' +
